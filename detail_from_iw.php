...
print $rows['foodstuff_seq_slot01'] . ":" . str_pad($rows['foodstuff_name_en_slot01'], 60, "#", STR_PAD_RIGHT) . "\n";
print $rows['foodstuff_seq_slot02'] . ":" . str_pad($rows['foodstuff_name_en_slot02'], 60, "#", STR_PAD_RIGHT) . "\n";
print $rows['foodstuff_seq_slot03'] . ":" . str_pad($rows['foodstuff_name_en_slot03'], 60, "#", STR_PAD_RIGHT) . "\n";
print $rows['foodstuff_seq_slot04'] . ":" . str_pad($rows['foodstuff_name_en_slot04'], 60, "#", STR_PAD_RIGHT) . "\n";
print $rows['foodstuff_seq_slot05'] . ":" . str_pad($rows['foodstuff_name_en_slot05'], 60, "#", STR_PAD_RIGHT) . "\n";
print $rows['foodstuff_seq_slot06'] . ":" . str_pad($rows['foodstuff_name_en_slot06'], 60, "#", STR_PAD_RIGHT) . "\n";
print $rows['foodstuff_seq_slot07'] . ":" . str_pad($rows['foodstuff_name_en_slot07'], 60, "#", STR_PAD_RIGHT) . "\n";
print $rows['foodstuff_seq_slot08'] . ":" . str_pad($rows['foodstuff_name_en_slot08'], 60, "#", STR_PAD_RIGHT) . "\n";
print $rows['foodstuff_seq_slot09'] . ":" . str_pad($rows['foodstuff_name_en_slot09'], 60, "#", STR_PAD_RIGHT);
